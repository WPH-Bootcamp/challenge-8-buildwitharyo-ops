...
function StepCard({ title, body }: { title: string; body: string }) {
  return (
    <div className="rounded-2xl bg-white dark:bg-[#14181f] border border-ink-200 dark:border-white/5 shadow-sm dark:shadow-none p-5 md:p-6 hover:border-primary/40 hover:-translate-y-0.5 transition-all duration-300">
    ...
    <section className="py-16 md:py-24">
      <Container>
        ...
        <div className="relative max-w-[1100px] mx-auto mt-16 md:mt-20">
          <span className="hidden md:block absolute left-1/2 top-5 bottom-5 w-px bg-ink-300 dark:bg-white/10 -translate-x-1/2" />
